...
app.use(cors({
    origin: ['http://localhost:3000', 'http://localhost:8000', 'https://tsm-web-git-admin-dashboard-the-scandinavian-method.vercel.app', 'https://tsm-prod-git-main-the-scandinavian-method.vercel.app','http://ec2-13-61-69-144.eu-north-1.compute.amazonaws.com:8000'],
